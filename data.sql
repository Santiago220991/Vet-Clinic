...
UPDATE animals SET species_id=(SELECT id FROM species WHERE name='Digimon') WHERE species_id IS NULL;
...
INSERT INTO vets (name, age, date_of_graduation) VALUES ('William Tatcher', 46, '2000-04-23');
...
INSERT INTO visits (name_id, vets_id, date_of_visit) VALUES ((SELECT id FROM animals WHERE name='Agumon'), (SELECT id FROM vets WHERE name='William Tatcher'), '2020-05-24');
...
INSERT INTO visits (name_id, vets_id, date_of_visit) VALUES ((SELECT id FROM animals WHERE name='Blossom'), (SELECT id FROM vets WHERE name='Stephanie Mendez'), '2021-01-11');
